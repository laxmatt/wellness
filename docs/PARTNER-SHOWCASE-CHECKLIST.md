...
| Price evidence | partly | $45 recorded 2026-09-08, relayed from a search summary rather than read from the merchant, not re-checked since |
| Image readiness | no | 1 procedural placeholder, no rights evidence |
...
| Wellness Drinks | 6 | 4 | 0 | 0 | 0 |

## Totals

**Comparison facts.** All required specifications usable and sourced: 0. Some: 20. None: 0.

**Price evidence.** An amount on record: 12. No amount on record: 8. Verified today: 0, on every product, because nothing was fetched.
...
1. **Read the pages already on file.** 124 of 196 attribute records and 13
   of 26 offer prices are marked `secondhand`, meaning the URL was recorded
   from a search summary and the page was never opened. Opening them turns
   a claim into a reading, and the URLs are already there.
