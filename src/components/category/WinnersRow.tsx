...
import { buyableOffers, displayOfferPrice, displayPrice } from "@/domain/view";
                  ...
                  <div className="mt-auto flex flex-col gap-2 pt-3">
                    {merchants.map((o) => (
                      ...
                      >
                        ...
                        {o.priceIsDemo ? null : <span className="tabular shrink-0 opacity-80">{displayOfferPrice(o)}</span>}
                      </a>
                    ))}
