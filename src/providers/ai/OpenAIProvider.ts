...
2. A requirement is "hard". A preference is "soft". The test is whether the shopper named the line, not whether they used a comparing word. "Under $2", "less than 90 cents", "no more than 200mg", "only inflatable", "zero sugar" all name the line, and every one of them is a requirement, comparing words included. "Cheapest", "smallest", "best", "as cheap as possible", "ideally light" name no line: they say how to order what is left, so they are preferences. If you find yourself choosing a number the shopper did not say, you are writing a preference, not a requirement. Getting this wrong either hides products the shopper asked to see or shows ones they ruled out.
